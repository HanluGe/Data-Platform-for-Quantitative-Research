...
if __name__ == "__main__":
    ...
    # filtered_data = data_workbench.filter_by_date_range("close", "2024-01-01", "2024-02-01")

    # # Filter by column value
    # filtered_data_by_value = data_workbench.filter_by_column_value("close", "ticker", "AAPL")

    # # Apply general filtering logic (e.g., filter rows with volume > 1M)
    # filtered_data = data_workbench.filter_data(
    #     "close",
    #     lambda df: df[df["volume"] > 1_000_000]
    # )
